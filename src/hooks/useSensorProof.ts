...
// export interface UseSensorProofOptions {
//   autoSave?: boolean; // Save proofs to local storage
//   sensorType: SensorType | 'gps' | 'accelerometer';
// }
...
//     try {
//       if (sensorType === SensorType.GPS || sensorType === 'gps') {
...
//         const newProof = await accelGenerator.generateMovementProof(options);
...
//       }
//     },
//     [accelGenerator, autoSave]
//   );

//   /**
//    * Detect steps with proof
//    */
//   const detectSteps = useCallback(
//     async (durationMs?: number): Promise<{ steps: number; proof: SensorProof } | null> => {
//       if (!seedVaultSigner.isAuthorized()) {
//         setError(new Error('Wallet not authorized'));
//         return null;
//       }
...
//         return result;
//       } catch (err) {
//         const error = err instanceof Error ? err : new Error('Step detection failed');
//         setError(error);
//         return null;
//       } finally {
//         setIsGenerating(false);
...
//   /**
//    * Subscribe to continuous location updates with proofs
//    */
...
//       try {
//         return await gpsGenerator.watchLocationWithProofs(async (proof) => {
//           setProof(proof);
...
//   /**
//    * Subscribe to continuous accelerometer updates with proofs
//    */
...
//       try {
//         return accelGenerator.subscribeWithProofs(async (data, proof) => {
//           if (proof) {
//             setProof(proof);
